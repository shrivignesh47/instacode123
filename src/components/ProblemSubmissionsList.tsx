...
import { getStatusColor } from '../utils/problemUtils';
    ...
    <div className="space-y-4">
      {submissions.map((submission) => (
        <div 
          ...
          onClick={() => navigate(`/problems/${submission.problems.slug}`)}
        >
          <div className="flex items-center justify-between mb-2">
            {showProblemName && submission.problems && (
              <h3 className="text-white font-medium">{submission.problems.title}</h3>
            )}
